    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/bilans/**").hasRole("BIOLOGUIQTE")
                        .requestMatchers(HttpMethod.GET, "/bilans/**").hasRole("BIOLOGUIQTE")
                        .requestMatchers(HttpMethod.DELETE, "/bilans/**").hasRole("BIOLOGUIQTE")
                        .requestMatchers(HttpMethod.PUT, "/bilans/**").hasRole("BIOLOGUIQTE")
